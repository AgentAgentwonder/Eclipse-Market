...
mod bridge_tests {
    ...
    fn test_bridge_provider_from_str() {
        assert_eq!(BridgeProvider::from_str("wormhole"), Some(BridgeProvider::Wormhole));
        assert_eq!(BridgeProvider::from_str("allbridge"), Some(BridgeProvider::AllBridge));
        assert_eq!(BridgeProvider::from_str("synapse"), Some(BridgeProvider::Synapse));
