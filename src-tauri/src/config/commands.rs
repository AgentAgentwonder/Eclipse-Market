use super::settings_manager::{SettingsManager, SharedSettingsManager, SettingsExport, SettingsProfile, SettingsChange};
use super::settings_schema::{UniversalSettings, SettingMetadata, SettingType};
use serde_json::json;
...
#[tauri::command]
pub async fn get_settings_template(template_type: String) -> Result<UniversalSettings, String> {
...
fn generate_settings_schema() -> Vec<SettingMetadata> {
    vec![
        ...
        SettingMetadata {
            ...
            description: "AI creativity level (0.0 = deterministic, 2.0 = very creative)".to_string(),
            setting_type: SettingType::Slider {
                min: 0.0,
                max: 2.0,
                step: 0.1,
        ...
        SettingMetadata {
            ...
            setting_type: SettingType::Select {
                options: vec!["subtle".to_string(), "normal".to_string(), "intense".to_string()],
            },
