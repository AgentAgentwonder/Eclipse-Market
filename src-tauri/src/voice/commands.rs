...
use super::speech_to_text::{LanguageOption, SpeechRecognitionResult, SpeechToTextConfig, SpeechToTextEngine};
...
#[tauri::command]
pub async fn voice_stop_microphone(
    state: State<'_, SharedVoiceState>,
) -> Result<(), String> {
    let voice_state = state.read().await;
...
#[tauri::command]
pub async fn voice_start_wake_word(
    state: State<'_, SharedVoiceState>,
) -> Result<(), String> {
    let voice_state = state.read().await;
...
#[tauri::command]
pub async fn voice_stop_wake_word(
    state: State<'_, SharedVoiceState>,
) -> Result<(), String> {
    let voice_state = state.read().await;
...
#[tauri::command]
pub async fn voice_start_recognition(
    state: State<'_, SharedVoiceState>,
) -> Result<(), String> {
    let voice_state = state.read().await;
...
pub async fn voice_simulate_transcription(
    ...
    let voice_state = state.read().await;
    Ok(voice_state.stt_engine.simulate_transcription(&transcript, confidence))
}
...
#[tauri::command]
pub async fn voice_pause_speaking(
    state: State<'_, SharedVoiceState>,
) -> Result<(), String> {
    let voice_state = state.read().await;
...
#[tauri::command]
pub async fn voice_resume_speaking(
    state: State<'_, SharedVoiceState>,
) -> Result<(), String> {
    let voice_state = state.read().await;
