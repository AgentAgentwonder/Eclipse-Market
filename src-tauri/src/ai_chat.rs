...
pub async fn ai_chat_message_stream(
    ...
    tokio::spawn(async move {
        ...
        for (i, word) in words.iter().enumerate() {
            ...
            let _ = app_clone.emit_all(&event_name_clone, serde_json::json!({
                "chunk": chunk,
                "done": false,
            }));
...
pub async fn ai_get_pattern_warnings() -> Result<Vec<PatternWarning>, String> {
    ...
    let warnings = vec![
        PatternWarning {
            ...
            description: "Detected suspicious volume spike followed by rapid price decline".to_string(),
        ...
        PatternWarning {
            ...
            description: "Large wallets have been accumulating this token over the past week".to_string(),
            recommendation: "Consider increasing position size, potential breakout incoming".to_string(),
        },
        PatternWarning {
            id: Uuid::new_v4().to_string(),
            timestamp: Utc::now().to_rfc3339(),
