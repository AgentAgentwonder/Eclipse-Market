...
impl AlertRule {
    ...
    fn evaluate_node(
        ...
        market_data: &MarketData,
        whale_activity: &Option<WhaleActivity>,
    ) -> (bool, Vec<ConditionEvaluationResult>, String, f64, Option<bool>) {
    ...
    fn evaluate_group(
        ...
        (triggered, all_results, message, avg_confidence, window_satisfied)
    }
    ...
    pub fn has_access(&self, user_id: &str, required_permission: Permission) -> bool {
        ...
        self.shared_with.iter().any(|access| {
            access.user_id == user_id
                && access.permission >= required_permission
        })
    }
}
