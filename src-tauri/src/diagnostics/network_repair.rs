...
impl NetworkDiagnostics {
    ...
    pub async fn diagnose(&self) -> ModuleDiagnostics {
        ...
        metrics.push(PanelMetric {
            ...
            value: if internet_ok { "Reachable" } else { "Unreachable" }.to_string(),
        ...
        metrics.push(PanelMetric {
            ...
            value: format!("{}/{} reachable", endpoints.len() - api_failures.len(), endpoints.len()),
    ...
    pub async fn auto_switch_endpoint(&self, issue: &DiagnosticIssue) -> Result<AutoRepairResult, String> {
