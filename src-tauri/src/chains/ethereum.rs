...
impl EthereumAdapter {
    pub fn new(rpc_url: String, chain_name: impl Into<String>, native_symbol: impl Into<String>) -> Self {
        Self {
            rpc_url,
...
impl ChainAdapter for EthereumAdapter {
    async fn get_balance(&self, wallet: &WalletInfo) -> Result<ChainBalance, String> {
        ...
        let wei_balance = data["result"]
            .as_str()
            .ok_or("Invalid balance result")?;
    ...
    async fn get_fee_estimate(&self, _wallet: &WalletInfo) -> Result<ChainFeeEstimate, String> {
        ...
        let gas_price_hex = data["result"]
            .as_str()
            .ok_or("Invalid gas price result")?;
