...
impl SettingsManager {
    ...
    pub fn export_settings(&self, sections: Option<Vec<String>>) -> Result<AppSettings, SettingsError> {
    ...
    pub fn get_template(&self, template_type: &str) -> Result<AppSettings, SettingsError> {
        let settings = match template_type {
            ...
            _ => return Err(SettingsError::Validation("Unknown template type".to_string())),
        };
