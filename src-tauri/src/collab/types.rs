...
pub enum CollabMessage {
    ...
    ParticipantLeft { participant_id: Uuid, user_id: String },
    ParticipantUpdated { participant: Participant },
    ChatMessage { message: ChatMessage },
    WatchlistUpdated { watchlist: SharedWatchlist },
    OrderShared { order: SharedOrder },
    OrderUpdated { order: SharedOrder },
    StrategyShared { strategy: Strategy },
    CompetitionUpdated { competition: Competition },
    LeaderboardUpdated { room_id: Uuid, leaderboard: Vec<LeaderboardEntry> },
    ModerationAction { action: ModerationAction },
    WebRTCSignal { signal: WebRTCSignal },
    StateSync { state: RoomState },
}
