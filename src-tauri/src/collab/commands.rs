...
#[tauri::command]
pub async fn collab_get_room(room_id: String, state: State<'_, CollabState>) -> Result<Room, String> {
...
pub async fn collab_join_room(
    ...
    state
        .websocket
        .subscribe_to_room(request.room_id, user_id);
