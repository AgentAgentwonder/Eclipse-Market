...
fn generate_mock_trending(limit: usize) -> Vec<TrendingCoin> {
    ...
    let mock_tokens = vec![
        ("BONK", "Bonk", "DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263", 0.000023),
        ("JUP", "Jupiter", "JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN", 1.23),
        ("WIF", "dogwifhat", "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm", 2.45),
        ("PYTH", "Pyth Network", "HZ1JovNiVvGrGNiiYvEozEVgZ58xaU3RKwX8eACQBCt3", 0.87),
        ("JTO", "Jito", "jtojtomepa8beP8AuQc6eXt5FriJwfFMwQx2v2f9mCL", 3.21),
        ("ORCA", "Orca", "orcaEKTdK7LKz57vaAYr9QeNsVEPfiu6QeMU1kektZE", 4.56),
        ("RAY", "Raydium", "4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R", 3.78),
        ("MNGO", "Mango", "MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac", 0.045),
        ("COPE", "Cope", "8HGyAAB1yoM1ttS7pXjHMa3dukTFGQggnFFH3hJZgzQh", 0.12),
        ("STEP", "Step Finance", "StepAscQoEioFxxWGnh2sLBDFp9d8rvKz2Yp39iDpyT", 0.089),
    ];
...
#[tauri::command]
pub async fn get_coin_sentiment(symbol: String, _api_key: Option<String>) -> Result<CoinSentiment, String> {
