...
impl InsuranceCoordinator {
    ...
    pub fn request_quote(
        ...
        let coverage_amount_usd = (trade_amount_usd * coverage_percentage)
            .min(provider.coverage_limit_usd);
        ...
        self.quote_cache.insert(provider_id.to_string(), quote.clone());
        Ok(quote)
    }
    ...
    pub fn recommend_provider(
        ...
        providers
            ...
            .min_by(|a, b| a.total_premium_usd.partial_cmp(&b.total_premium_usd).unwrap())
    }
