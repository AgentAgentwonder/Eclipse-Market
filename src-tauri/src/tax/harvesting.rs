...
impl TaxLossHarvester {
    ...
    pub fn generate_recommendations(
        ...
        for lot in open_lots {
            ...
            let wash_sale_risk = self
                .wash_sale_detector
                .check_potential_wash_sale(&lot.symbol, Utc::now(), recent_asset_purchases);
    ...
    fn calculate_priority(
        ...
        let near_long_term_boundary = holding_period_days >= self.jurisdiction.holding_period_days - 30
    ...
    fn generate_reason(
        ...
        if reasons.is_empty() {
            format!("Loss harvesting opportunity: ${:.2} tax savings", tax_savings)
        } else {
            reasons.join(". ")
        }
    }
